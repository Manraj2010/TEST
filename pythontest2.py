...
comparison_results_file2 = 'comparison_results.txt'
with open(comparison_results_file2, 'w') as result_file2:
    for line in diff2:
        result_file2.write(line + '\n')

print(f'Comparison results saved to: {comparison_results_file}')
print(f'Comparison results saved to: {comparison_results_file2}')
